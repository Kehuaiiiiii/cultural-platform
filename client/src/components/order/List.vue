...
<!--      </el-row>-->
      ...
      <el-table class="table" :data="orderList" border stripe highlight-current-row>
        ...
        <el-table-column label="支付状态" prop="pay_status" width="140px" :resizable="false"></el-table-column>
        <el-table-column label="物流状态" prop="send_status" width="140px" :resizable="false"></el-table-column>
        ...
        <el-table-column label="操作" width="100px" :resizable="false">
          <template slot-scope="scope">
            ...
            <el-tooltip class="tooltip" effect="dark" content="支付" placement="top">
